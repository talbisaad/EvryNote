<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
      ...
      <ul class="listop">
          <li><div class="titleitm">Filiere<span class="togl">[ - ]</span></div>
             <ul class="subItm">
                 <li><a href="/EvryNote/platform/CreerFil">Creer une filiere</a></li>
                 <li><a href="/EvryNote/platform/ListFil">Lister les filieres</a></li>
                 <li><a href="/EvryNote/platform/GestionFil">Gerer une filiere</a></li>
             </ul>
          </li>
