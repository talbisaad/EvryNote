...
<ul class="listop">
	<li><div class="titleitm">
			Filiere<span class="togl">[ - ]</span>
		</div>
		<ul class="subItm">
			<li><a href="/EvryNote/CreerFil.jsp">Creer une filiere</a></li>
			<li><a href="/EvryNote/ListFil.jsp">Lister les filieres</a></li>
			<li><a href="/EvryNote/GestionFil.jsp">Gerer une filiere</a></li>
		</ul></li>
	<li><div class="titleitm">
			Classe<span class="togl">[ - ]</span>
		</div>
		<ul class="subItm">
	...
	<li><div class="titleitm">
			Responsable de filiere<span class="togl">[ - ]</span>
		</div>
		<ul class="subItm">
			<li><a href="?page=">Creer un responsable de filiere</a></li>
			<li><a href="?page=">Lister les responsables des filieres</a></li>
		</ul></li>
	<li><div class="titleitm">
